...
export const PushkinBannerWidget = () => {
  return (
    <div className="relative mx-auto w-full max-w-[1500px] sm:px-8 md:px-12 lg:px-16">
      {/* Десктопная версия (скрыта на мобильных) */}
      <div className="relative hidden h-[274px] sm:block">
        ...
        <div className="absolute left-10 top-44 flex items-center gap-2 sm:left-[165px] sm:top-[202px]">
          <Badge className="text-sm sm:text-base">
      ...
      <div className="relative mx-auto block h-96 w-80 sm:hidden">
        <div className="absolute left-0 top-0 h-96 w-80 rounded-3xl bg-[#5dd241]" />
        <div className="absolute left-5 top-12 w-52 text-2xl font-semibold leading-7 text-white">
          Все предложения
          <br />
          по Пушкинской карте здесь
        </div>
